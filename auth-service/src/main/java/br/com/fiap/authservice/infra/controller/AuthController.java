...
public class AuthController {
    ...
    public ResponseEntity<String> logout(@AuthenticationPrincipal Jwt jwt) {
        long expiresIn = jwt.getExpiresAt() != null ? 
                (jwt.getExpiresAt().getEpochSecond() - System.currentTimeMillis() / 1000) : 3600;
    ...
    public ResponseEntity<String> privateTest(@AuthenticationPrincipal Jwt jwt) {
        return ResponseEntity.ok("Hello " + jwt.getClaimAsString("preferred_username") + "! This is a private endpoint");
    }
}
