  ...
  public String getOrCreateTraceId() {
    try {
      ...
      if (attributes != null) {
        ...
        Object existingTraceId =
            attributes.getAttribute(TRACE_ID_ATTR, ServletRequestAttributes.SCOPE_REQUEST);
  ...
  public String getOrCreateCorrelationId() {
    try {
      ...
      if (attributes != null) {
        ...
        Object existingCorrelationId =
            attributes.getAttribute(CORRELATION_ID_ATTR, ServletRequestAttributes.SCOPE_REQUEST);
        if (existingCorrelationId != null) {
          return existingCorrelationId.toString();
        }
        String newCorrelationId = generateCorrelationId();
        attributes.setAttribute(
            CORRELATION_ID_ATTR, newCorrelationId, ServletRequestAttributes.SCOPE_REQUEST);
